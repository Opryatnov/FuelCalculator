...
final class FuelTableViewCell: BaseTableViewCell {
    ...
    static let identifier: String = "FuelTableViewCell"
    ...
    func fill(fuel: Fuel) {
        ...
        configureFavoriteImage(isSelected: fuel.isSelected)
    ...
    override func configureViews() {
        ...
        fuelView.addSubview(actionImageView)
    }
    ...
    override func setupConstraints() {
        ...
        stackView.snp.makeConstraints {
            ...
            $0.trailing.lessThanOrEqualTo(actionImageView.snp.leading).inset(-Constants.FuelPriceLabel.leftInset)
        }
    ...
    private func configureFavoriteImage(isSelected: Bool) {
        actionImageView.image = isSelected ? UIImage(named: "selected") : UIImage(named: "nonSelected")
    }
}
